...
1. 右上の `Fork` ボタンを押してください。Copy the `main` branch only のチェックを外してフォークを作成します。
   - 注意！ フォークを実行する際は「Copy the main branch only」のチェックボックスを必ず外してください。 <img width="754" alt="fork" src="https://user-images.githubusercontent.com/1148320/214180321-800b1a97-5264-43e6-8459-8d936dff71de.png">
3. `#{自分のアカウント名}/fjord-books_app-2023` が作成されます。
...
4. `cd fjord-books_app-2023` でカレントディレクトリを変更してください。
